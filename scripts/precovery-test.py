...
DATABASE_DIR = "/epyc/ssd/users/moeyensj/precovery/precovery_data/nsc/precovery_defrag_db"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--orbits_file",
        default=ORBITS_FILE,
        type=str
    )
