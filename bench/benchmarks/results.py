...
class BackendRunResults(qv.Table):
    ...
    max_on_sky_sigma_major_arcsec = qv.Float64Column(nullable=True)
    ...
    n_frames_stage3_rejected_any = qv.Int64Column(nullable=True)
    n_frames_truth_stage3_rejected_any = qv.Int64Column(nullable=True)
    n_frames_lim_mag_rejected = qv.Int64Column(nullable=True)
    n_frames_lim_mag_truth_rejected = qv.Int64Column(nullable=True)
    n_frames_uncertainty_rejected = qv.Int64Column(nullable=True)
    n_frames_truth_uncertainty_rejected = qv.Int64Column(nullable=True)
    ...
    n_frames_skipped_uncertainty = qv.Int64Column()
    n_targets_preprop_viability_rejected = qv.Int64Column(nullable=True)
    n_targets_preprop_time_limited = qv.Int64Column(nullable=True)
    n_targets_failfast_dynamics_error = qv.Int64Column(nullable=True)
    n_targets_eval_total = qv.Int64Column(nullable=True)
    n_targets_eval_after_policy = qv.Int64Column(nullable=True)
    completed_full_time_period_check = qv.BooleanColumn(nullable=True)
    ...
    n_detections_innov_ellipse_rejected = qv.Int64Column(nullable=True)
    n_detections_magnitude_rejected = qv.Int64Column(nullable=True)
    n_detections_selected_exposure_keys = qv.Int64Column(nullable=True)
    n_detections_selected_frame_keys = qv.Int64Column(nullable=True)
    n_detections_healpixel_nonmatch = qv.Int64Column(nullable=True)
