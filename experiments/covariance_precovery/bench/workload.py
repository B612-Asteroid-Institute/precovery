...
from .types import BenchTargets, MonthWindow, SubsetPaths
...
def _mjd_utc_from_ymd(year: int, month: int, day: int) -> float:
    ...
    Copied conceptually from `experiments/covariance_precovery/data/subset_db.py` so the
    benchmarking harness can define month windows without importing CLI helpers.
    """
